...
class Header extends React.Component {
    ...
    enableVideo(){
        ...
        else if (this.state.playVideo == true) {
                    ...
                    <Navbar collapseOnSelect expand="lg">
                        <Container>
                            <Navbar.Brand href="#home" style={{ paddingTop: 10 }}>
                                <img className="poopah" src={il} alt='logo' />
                            </Navbar.Brand>
                            ...
                            <Navbar.Collapse id="responsive-navbar-nav">
                                ...
                                <Nav style={{ borderRadius: 0, padding: "0 20px 0 20px", fontWeight: 900 }}>
                                    ...
                                    <div>
                                        <a style={{ textDecoration: "none", color: "white"}} target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/cheeky__chimps/"> <BsInstagram size={20} /></a>
                                        <a style={{ textDecoration: "none", color: "white" }} target="_blank" rel="noopener noreferrer" href="https://twitter.com/cheeky__chimps"> <BsTwitter size={20} /></a>
                                        <a style={{ textDecoration: "none", color: "white", }} target="_blank" rel="noopener noreferrer" href="https://discord.com/invite/cheeky-chimps"> <BsDiscord size={20} />   </a>
                                    </div>
