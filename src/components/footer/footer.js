                    ...
                    <Row style={{ width: "100%", paddingBottom: 20 }}>
                        ...
                        <Col md="3" className="footer-social">
                            ...
                            <div className="social-button-container">
                                <a className="social-button" href="https://www.discord.gg/cheeky-chimps">
                                ...
                                <a className="social-button" href="https://twitter.com/Cheeky__Chimps">
                                ...
                                <a className="social-button" href="https://www.instagram.com/cheeky__chimps/">
